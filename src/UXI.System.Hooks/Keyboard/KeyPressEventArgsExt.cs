...
namespace UXI.System.Hooks.Keyboard
{
    ...
    {
        internal KeyPressEventArgs(char keyChar, int timestamp)
        {
            KeyChar = keyChar;
        ...
        internal static KeyPressEventArgs FromRawData(int wParam, IntPtr lParam, bool isGlobal)
        {
            return isGlobal ?
        ...
        /// <param name="lParam">The second Windows Message parameter.</param>
        /// <returns>A new KeyPressEventArgsExt object.</returns>
        private static KeyPressEventArgs FromRawDataApp(int wParam, IntPtr lParam)
        {
            ...
            {
                return new KeyPressEventArgs((char)0);
            }
            ...
            bool isSuccessfull = WinApi.TryGetCharFromKeyboardState(virtualKeyCode, scanCode, fuState, out ch);
            if (!isSuccessfull)
            {
                return new KeyPressEventArgs((char)0);
            }

            return new KeyPressEventArgs(ch);
        ...
        /// <param name="lParam">The second Windows Message parameter.</param>
        /// <returns>A new KeyPressEventArgsExt object.</returns>
        internal static KeyPressEventArgs FromRawDataGlobal(int wParam, IntPtr lParam)
        {
            ...
            if (virtualKeyCode == WinApi.VK_PACKET)
            {
                ch = (char)scanCode;
            }
            else
            ...
            KeyPressEventArgs e = new KeyPressEventArgs(ch, keyboardHookStruct.Time);
            return e;
        }

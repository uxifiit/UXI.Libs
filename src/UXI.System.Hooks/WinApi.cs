...
using System.Text;
using UXI.System.Hooks.Keyboard;
...
namespace UXI.System.Hooks
{
    class WinApi
    {
        #region MouseEvents
        /// <summary>
        /// Prida do hook chainu novy hook
        /// </summary>
        /// <param name="idHook">Ake spravy chceme zachytavat - v nasom pripade WH_MOUSE_LL cize 14</param>
        /// <param name="lpfn">Referencia na metodu, ktora bude volana</param>
        /// <param name="hMod">Pointer na nas program</param>
        /// <param name="dwThreadId">id threadu</param>
        /// <returns>Handle na vytvoreny hook</returns>
        [DllImport("user32.dll", CharSet = CharSet.Auto,
        CallingConvention = CallingConvention.StdCall, SetLastError = true)]
        internal static extern int SetWindowsHookEx(int idHook, UXI.System.Hooks.HookBase.HookCallbackDelegate lpfn, IntPtr hMod, int dwThreadId);

        /// <summary>
        /// Odstrani hook z hook chainu
        /// </summary>
        /// <param name="idHook">Handle na hook, ktory sme ziskali pri volani SetWindowsHookEx</param>
        /// <returns></returns>
        [DllImport("user32.dll", CharSet = CharSet.Auto,
        CallingConvention = CallingConvention.StdCall, SetLastError = true)]
        ...
        /// <summary>
        /// Posle informacie o sprave prijatej hookom dalsiemu hooku v chaine, aby ju mohol spracovat ten
        /// </summary>
        ...
        /// <summary>
        /// Ziska z OS cas, za ktory musi pouzivatel dvakrat kliknut, aby boli dve kliknutia brane ako double click.
        /// </summary>
        /// <returns></returns>
        [DllImport("user32")]
        ...
        {
            IntPtr hActiveWnd = GetForegroundWindow();  //handle to focused window
            int dwProcessId;
            int hCurrentWnd = GetWindowThreadProcessId(hActiveWnd, out dwProcessId); //thread of focused window
